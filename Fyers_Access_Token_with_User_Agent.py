...
To generate access token using TOTP (Recommended):
https://github.com/tkanhe/Fyers-API-Access-Token-Generation-V2/blob/main/fyers_access_token_totp.py

To generate access token using password:
https://github.com/tkanhe/Fyers-API-Access-Token-Generation-V2/blob/main/fyers_access_token_password.py
